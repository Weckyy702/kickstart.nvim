...
require('lazy').setup({
  ...
  {
    -- highlight comments with special text
...
require('nvim-treesitter.configs').setup {
  ...
  textobjects = {
    ...
    move = {
      ...
      --TODO can't do these keybindings on a german keyboard layout :(
      goto_next_start = {
        [']m'] = '@function.outer',
        [']]'] = '@class.outer',
      },
...
local servers = {
  clangd = {
    checkUpdates = false,
    fallbackFlags = "-I. -std=c++20 -Wall -Wextra -pedantic -Wconversion",
...
-- Show column limit at 80 character
